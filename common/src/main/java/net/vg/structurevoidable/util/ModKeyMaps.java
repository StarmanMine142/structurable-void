...
public class ModKeyMaps {
    ...
    static KeyMapping.Category STRUCTUREVOIDABLE_CATEGORY = new KeyMapping.Category(
            Identifier.fromNamespaceAndPath(Structurevoidable.MOD_ID, "structurevoidable_category")
    );
